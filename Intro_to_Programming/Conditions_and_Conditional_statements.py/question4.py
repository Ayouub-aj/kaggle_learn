...
# so they must pay $100 (cost of plan), plus $0.10 * 100 = $10, for a total bill of $110. In other words, get_phone_bill(15.1) should return 110.
...
print(get_phone_bill(15.1))  # Output: 110.0
print(get_phone_bill(20))    # Output: 600.0
print(get_phone_bill(15))    # Output: 100
print(get_phone_bill(16.5))  # Output: 250.0