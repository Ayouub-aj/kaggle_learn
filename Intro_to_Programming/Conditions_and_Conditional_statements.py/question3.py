...
# Example usage:
print(get_water_bill(10000))  # Output: 60.0
print(get_water_bill(25000))  # Output: 175.0
print(get_water_bill(5000))   # Output: 25.0
print(get_water_bill(35000))  # Output: 350.0
print(get_water_bill(8000))   # Output: 40.0